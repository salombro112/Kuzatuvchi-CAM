...
function renderDetail(id) {
  ...
  return `
    ...
    <div class="detail-hero" ${p.image ? `style="background-image:url('${p.image}');background-size:contain;background-repeat:no-repeat;background-position:center;"` : ""}>${p.image ? "" : "📷"}</div>
    ${isAdmin() ? `
